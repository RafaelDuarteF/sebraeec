...
<div id="menuMascote">
	...
	<script>
		...
		function setDate() { 
		    ...
		    switch (weekDay) {
		    case  0:
		        document.getElementById("date").innerHTML = "Domingo, " + monthDay + "/" + monthYear + "/" + year.substring(1) + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Domingo = 0) em getDay().
		        break;
		    case  1:
		        document.getElementById("date").innerHTML = "Segunda, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Segunda = 1) em getDay().
		        break;
		    case  2:
		        document.getElementById("date").innerHTML = "Terça, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Terça = 2) em getDay().
		        break;
		    case  3:
		        document.getElementById("date").innerHTML = "Quarta, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Quarta = 3) em getDay().
		        break;
		    case  4: 
		        document.getElementById("date").innerHTML = "Quinta, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Quinta = 4) em getDay().
		        break;
		    case  5:
		        document.getElementById("date").innerHTML = "Sexta, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Sexta = 5) em getDay().
		        break;
		    case  6:
		        document.getElementById("date").innerHTML = "Sábado, " + monthDay + "/" + monthYear + "/" + year.substring(1) + "<br>" + hour + ":" + minutes + ":" + seconds; //(Sábado = 6) em getDay().
		        break; 
			}    
		}  
	</script>
