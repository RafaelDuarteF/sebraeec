	...
	<img src="img/mascote.png?<?php echo time(); ?>" id="acessImg">
		...
		<div id="slider-body-part">
			<div id="slider">
				...
				<img class="slidersImg" id="slider-img2" src="img/slider4.jpg?<?php echo time(); ?>" alt="Nossos produtos."> 
		...
		<div id="one-body-part"> <!-- Primeira partição do corpo da página. -->
			...
			<div id="bocha">
				...
				<div class="text-bocha-malha">O jogo de <a href="pagBocha.php">Bocha</a> é muito conhecido por ser um esporte de precisão, 
			...
			<div id="malha">
				...
				<div class="text-bocha-malha">O jogo de <a class="hrefIndex"  href="pagMalha.php">Malha</a> é extremamente similar ao jogo de Bocha, entretanto o 
		...
		<div id="second-body-part"> <!-- Segunda partição do corpo da página. -->
			<div id="text-information-for-club">Constantemente organizamos campeonatos visando o entretenimento para a 
				...
				<a class="hrefIndex" href="pagProdutos.php">produtos</a>! Ideal para você que pratica esses esportes<br>e acompanha <a class="hrefIndex"  href="pagSobreClube.php">nosso clube</a>!
			</div>
