<?php
    $conAvas = "SELECT * FROM avaliacao WHERE codProduto = $codProd[$idProd] and estrelas >= 3 ORDER BY estrelas DESC";
...
<?php
    ...
    if($avasData == 0){
        ?>
            <p class="semComent">Não há avaliações positivas neste produto!</p>
        <?php
    }
?>