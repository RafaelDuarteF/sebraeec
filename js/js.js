...
function identificarDispositivo(){
	...
	if(/Android|iPhone|chrome/i.test(navigator.userAgent) && screen.width <= 480 ){ /* Caso o 
	dispositivo seja Android ou iPhone, e com tela menor que 480px de largura 
	(Celulares padrões), o site é adaptado para tal. */ 

		// ITENS ADAPTADOS EXISTENTES EM TODAS AS PÁGINAS

		login_cadastro = $("#area-login-cadastro");
		login_cadastro.hide();
		cadastro_login_mobile = $(".cadastro-login-mobile");
		cadastro_login_mobile.show();
		$("#logo-nome").css("float", "none");
		$("#logo-nome").css("margin-left", "190px");
		$("#logo-nome").css("margin-top", "35px");
		$("footer").css("height", "480px");
		$("footer").css("width", "480px");
		$("#header-two").css("width", "480px");
		$("#footer-one").css("width", "480px");
		$("header").css("width", "480px");
		$("#logo").css("float", "none");
		$("#logo").css("width", "100%");
		$("#img-logo").css("margin-left", "58px");
		$("#text-footer-left").css("text-align", "center");
		$("#text-footer-left").css("margin-left", "0");
		$("#text-footer-right").css("text-align", "center");
		$("#text-footer-center").css("margin-top", "10px");
		$("#text-footer-center").css("padding-right", "0px");
		$("#text-footer-right").css("margin-top", "45px");
		$("#text-footer-right").css("margin-right", "0px");
		$("header").css("height", "210px");
		$("#redes-sociais").css("width", "100px");
		$("#redes-sociais").css("margin-left", "190px");
		$("#redes-sociais").css("margin-bottom", "50px");
		$("iframe").css("width", "480px");
		$("iframe").css("height", "400px");
		$("iframe").css("position", "absolute");
		$("iframe").css("right", "0");
		$("iframe").css("left", "0");
		$("#login").css("width", "460px");
		$("#login").css("margin-left", "-230px");
		$("#cadastro").css("width", "460px");
		$("#cadastro").css("margin-left", "-230px");



		// ITENS ADAPTADOS EXISTENTES NA PÁGINA PRINCIPAL



		$("#slider").css("height", "150px");
		$("#slider").css("width", "480px");
		legendaSlider = $(".legenda");
		legendaSlider.hide();
		$("#slider img").css("height", "150px");
		$("#slider img").css("width", "480px");
		$("#seta2").css("margin-left", "415px");
		$(".setas").css("margin-top", "16px");
		$("#setasDiv").css("width", "480px");
		$("#seta").css("margin-top", "36px");
		$("#bocha, #malha").css("width", "200px");
		$("#bocha, #malha").css("height", "280px");
		$("#bocha, #malha").css("margin-top", "27px");
		$("#malha").css("margin-left", "50px");
		$("#bocha").css("margin-left", "9px");
		$("#bocha-malha").css("width", "480px")
		$("#img-bocha, #img-malha").css("height", "80px");
		$("#img-bocha, #img-malha").css("width", "170px");
		$("#img-bocha, #img-malha").css("margin-left", "15px");
		$("#img-bocha, #img-malha").css("margin-top", "15px");
		$(".text-bocha-malha").css({
			fontSize:'12px',
			marginTop:'12px',
			marginLeft:'15px',
			marginRight:'15px'
			});
		$("#one-body-part").css("width", "480px");
		$("#one-body-part").css("height", "340px");
		$("#second-body-part").css("width", "480px");
		$("#second-body-part").css("height", "230px");
		$("#text-information-for-club").css("margin-left", "10px");
		$("#text-information-for-club").css("margin-top", "50px");
		$("#text-information-for-club").css("font-size", "12px");
		$("#text-information-for-club").css("float", "none");
		$("#text-information-for-club").css("text-align", "center");
		$("#img-clube").css("width", "200px");
		$("#img-clube").css("height", "110px");
		$("#img-clube").css("float", "none");
		$("#img-clube").css("position", "absolute");
		$("#img-clube").css("margin-right", "0px");
		$("#img-clube").css("margin-left", "145px");
		$("#img-clube").css("margin-top", "30px");


		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE BOCHA E MALHA


		$("#one-body-part-bochaPag").css("height", "auto");
		$("#one-body-part-malhaPag").css("height", "auto");
		$("#one-body-part-malhaPag, #one-body-part-bochaPag").css("margin-bottom", "20px");
		$("#one-body-part-bochaPag, #title-bochaPag-div, #title-malhaPag-div, #one-body-part-malhaPag, #text-malhaPag-div, #text-bochaPag-div").css("width", "480px");
		$("#text-bochaPag-div, #text-malhaPag-div").css("margin-left", "0px");
		$(".text-bochaPag, .text-malhaPag").css("margin-left", "22px");
		$(".text-bochaPag, .text-malhaPag").css("margin-right", "22px");
		$(".text-bochaPag, .text-malhaPag").css("font-size", "16px");
		$("#title-bochaPag-div img, #title-malhaPag-div img").css("width", "478px")
		$("#title-bochaPag-div, #title-malhaPag-div").css("height", "40px")
		$(".bochaMalha-img").css("margin-left", "15px")
		$("#bocha-img3, #malha-img3").css("width", "450px")


		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE QUEM SOMOS


		$(".devs-projeto").css("float", "none");
		$(".devs-projeto").css("margin-left", "0px");
		$(".body-parts-qSomos").css("height", "500px");
		$("#title-qSomos-div, #one-body-part-qSomos").css("width", "480px");
		$("#one-body-part-qSomos").css("height", "11900");
		$("#second-body-part-qSomos").css("width", "480px");


		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE O CLUBE


		$("#slider-sobreClube, #one-body-part-sobreClube, #second-body-part-sobreClube").css("width", "480px");
		$("#one-body-part-sobreClube").css("height", "auto");
		$("#second-body-part-sobreClube").css("height", "auto");
		$("#one-body-part-sobreClube, #second-body-part-sobreClube").css("margin-bottom", "30px");
		$("#slider-sobreClube").css("height", "120px");
		$("#slider-sobreClube img").css("width", "478px");
		$(".text-sobreClube").css("margin-left", "22px");
		$(".text-sobreClube").css("margin-bottom", "30px");
		$(".text-sobreClube").css("margin-right", "22px");
		$("#second-body-part-sobreClube img").css("margin-left", "15px");


		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE OS PRODUTOS DO CLUBE


		$("#produtos-body-part-one").css("width", "480px");
		$(".areaProduto").css("margin-left", "75px");
		$(".areaTextoProduto").css("margin-right", "55px");
		$("#menuProduto").css("width", "470px");
		$("#menuProduto").css("margin-left", "-235px");
		$("#produtoImg").css("margin-left", "108px")
		$("#comprar").css("margin-left", "135px");
		$("#menuProduto").css("width", "460px");
		

		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE OS EVENTOS DO CLUBE

		$("#month").css("height", "80px");
		$(".weekdays").css("height", "10px");
		$(".days, .days1, .champ").css("height", "50px");
		$(".days, .days1, .champ").css("width", "50px");
		$("table").css({
			height: "420px",
			width: "420px"
		})
		$("#events-information").css("width", "460px");
		$(".novdays").css({
			width: "70px",
			height: "70px",
			marginLeft: "10px"
		...
		// ITENS ADAPTADOS EXISTENTES NA PÁGINA SOBRE A IDENTIDADE VISUAL DO CLUBE

		$("#title-pagIdvisual").css("width", "480px");
		object = $("object");
		textObject = $("#text-Idvisual");
		textObject.hide();
		object.hide();
		$(".areaTextoProduto").css("margin-left", "55px");
		$("#one-body-part-Idvisual").css("width", "480px");
		$("#download-idVisual").css("margin-left", "120px");
