		...
		<footer>
			<div id="texts-footer">
				...
				<div class="text-footer" id="text-footer-right"><h4>Endereços</h4>
					<div class="sedes" id="sede1">
						<a>CEP: 74680-210</a><br>
						<a>Estado: Goiás</a><br>
						<p>Cidade: Goiânia</a><br>
						<a>Rua das palmeiras, 1355</a>
					</div><br>
					<div class="sedes">
						<a>CEP: 76710-000</a><br>
						<a>Estado: Goiás</a><br>
						<p>Município: Aruanã</a><br>
						<a>Rua Rio Cristalino, 143</a>
					</div>
				</div>
			</div>
			<br><br><br><br>
