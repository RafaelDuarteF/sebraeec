...
<div id="menuMascote">
	...
	<img src="img/mascote.png?<?php echo time(); ?>" id="acessImg">
		...
		<div id="second-body-part-sobreClube">
			...
			<p>&nbsp Os nossos clubes oferecem também o seu espaço físico em torno de 5.000m² de área que é utilizada como área de lazer por todos os nossos associados com grandes piscinas, restaurantes e campos para diversas modalidades e exaltando a bocha e a malha, acessível com a realização da carteirinha do clube que pode ser realizada tanto presencialmente, quanto remotamente. Também contamos com produtos personalizados do clube que podem ser adquiridos tanto em nosso clube físico quanto pelo nosso site, na página: <a href="pagProdutos.php">ww.sec.com/produtos.</a><br><br></p>
			<p>&nbsp O clube encontra-se aberto de quarta à sexta, das 09hs às 16hs, aos fins de semana, das 08hs às 18hs e feriados das 10hs às 16hs. Com nosso atendimento na recepção ou atendimento virtual do clube, você pode realizar na hora a carteirinha do clube, ou sanar todas suas dúvidas. Você também pode entrar em contato conosco através do número telefone: (11) 8221-9231, ou com o nosso amigo TucanoWeb ou através de nosso e-mail: <a href="">sebrae.ec@gmail.com</a>.<br><br></p>
